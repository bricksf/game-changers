...
var GameChangersSite={page:{init:function(){},finalize:function(){}},home:{init:function(){$(".slick").slick()},finalize:function(){}}},UTIL={fire:function(i,e,n){var t=GameChangersSite;e=void 0===e?"init":e,""!==i&&t[i]&&"function"==typeof t[i][e]&&t[i][e](n)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(i,e){UTIL.fire(e)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents),function(){function i(){$(".divider").each(function(){var i=0;$(this).find(".block-3").each(function(){$(this).height()>i&&(i=$(this).height())}),$(this).find(".block-3").height(i)})}$(".people-select li").each(function(i,e){$(e).on("click",function(i){i.preventDefault(),$(e).addClass("active").siblings().removeClass("active");var n=$(e).find("a").attr("href");n=n.substring(1),"all"==n?$(".person").removeClass("dim"):(n="."+n,$(".person").addClass("dim"),$(n).removeClass("dim"))})}),$(window).load(function(){i()}),$(".subnav a").click(function(){return $("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1})}(jQuery),$(function(){$(".easy-modal").easyModal({top:200,overlay:.2}),$('#site-navigation a[title="Recommend a Game Changer"]').click(function(i){var e=$(this).attr("href");$(e).trigger("openModal"),i.preventDefault()})});