...
var GameChangersSite={page:{init:function(){},finalize:function(){}},home:{init:function(){$(".slick").slick()},finalize:function(){}}},UTIL={fire:function(e,i,n){var t=GameChangersSite;i=void 0===i?"init":i,""!==e&&t[e]&&"function"==typeof t[e][i]&&t[e][i](n)},loadEvents:function(){UTIL.fire("common"),$.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(e,i){UTIL.fire(i)}),UTIL.fire("common","finalize")}};$(document).ready(UTIL.loadEvents),function(){function e(){$(".divider").each(function(){var e=0;$(this).find(".block-3").each(function(){$(this).height()>e&&(e=$(this).height())}),$(this).find(".block-3").height(e)})}$(".people-select li").each(function(e,i){$(i).on("click",function(e){e.preventDefault(),$(i).addClass("active").siblings().removeClass("active");var n=$(i).find("a").attr("href");n=n.substring(1),"all"==n?$(".person").removeClass("dim"):(n="."+n,$(".person").addClass("dim"),$(n).removeClass("dim"))})}),$(window).load(function(){e()}),$(".subnav a").click(function(){return $("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},500),!1}),$(".menu-toggle").on("click",function(){$("#menu-menu-1").toggleClass("show")})}(jQuery),$(function(){$(".easy-modal").easyModal({top:200,overlay:.2}),$('#site-navigation a[title="Recommend a Game Changer"]').click(function(e){var i=$(this).attr("href");$(i).trigger("openModal"),e.preventDefault()})});